...
*  [Odia Treebank (ODTB)](https://github.com/UniversalDependencies/UD_Odia-ODTB/tree/dev) : Odia UD Treebank, now part of **Universal Dependencies v2.18** (24th release, 353 treebanks across 193 languages). Expanded from 1,029 to **5,818 annotated instances**. 
    - [UD v2.18 Release](https://universaldependencies.org/#download) : Official Universal Dependencies v2.18 release page with download links for all 353 treebanks
    - [Odia ODTB Treebank Page](https://universaldependencies.org/treebanks/or_odtb/index.html) : Odia ODTB treebank details and statistics on the Universal Dependencies website
